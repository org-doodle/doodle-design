...
public abstract class AbstractPacketEncoderMethodReturnValueHandler
  ...
  protected AbstractPacketEncoderMethodReturnValueHandler(
  ...
  public Mono<Void> handleReturnValue(
    ...
    Flux<DataBuffer> encodedContent =
        encodeContent(
            ...
            bufferFactory,
            mimeType,
            handleHints(returnValue, returnType, message));
  ...
  protected Flux<DataBuffer> encodeContent(
